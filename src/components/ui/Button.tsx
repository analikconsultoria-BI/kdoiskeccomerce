...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className = "", variant = "primary", size = "md", fullWidth, children, ...props }, ref) => {
    ...
    const variants = {
      primary: "bg-accent-500 text-white shadow-sm shadow-accent-500/20 hover:bg-accent-600 hover:shadow-lg focus:ring-2 focus:ring-accent-200 focus:ring-offset-2",
      secondary: "bg-white border border-warm-200 text-warm-700 hover:bg-warm-50 hover:border-warm-300 shadow-sm focus:ring-2 focus:ring-warm-100 focus:ring-offset-2",
      ...
      outline: "bg-transparent border-2 border-brand-600 text-brand-600 hover:bg-brand-50 font-black",
    };
